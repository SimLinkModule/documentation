...
Damit der vorhandene Testaufbau auf Steckbrettern kompakt, mobil und benutzerfreundlich verwendet werden kann, sind alle benötigten Elektronikkomponenten in drei Platinen integriert. Durch die Aufteilung der Elektronikkomponenten auf drei Platinen ist es möglich während der Gehäuseerstellung eine größtmögliche Flexibilität zu haben. In Abbildung ... ist die Platine, welche zur Verbindung zur Multikopterfernsteuerung dient, zu sehen. In Abbildung ... ist die Hauptplatine zu sehen, welche die Spannungsregulierung, den ESP32-Mikrocontroller und eine Buchse für das Programmieren des ESP32-Mikrocontrollers enthält. Die dritte Platine, die alle Eingabe- und Ausgabeelemente enthält, ist in Abbildung ... zu sehen.
...
Die vollständigen Schaltpläne aller Platinen sind im Anhang ... bis ... zu finden.
...
Für weitere Details sind alle Platinenentwürfe öffentlich unter folgenden Link zu finden:\\ \url{https://github.com/SimLinkModule/PCB}
...
Für weitere Details alle 3D-Modelle öffentlich unter folgenden Link zu finden:\\ \url{https://github.com/SimLinkModule/Shell}