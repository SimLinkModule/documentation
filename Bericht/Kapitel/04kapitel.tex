...
Damit der vorhandene Testaufbau auf Steckbrettern kompakt, mobil und benutzerfreundlich verwendet werden kann, sind alle Elektronikkomponenten in drei Platinen integriert. Die Aufteilung in drei Platinen fand statt, da während des Platinenentwurfs noch nicht der finalen Aufbau des Gehäuses bekannt war und für eine größere Flexibilität während der Gehäuseerstellung gesorgt hat.
