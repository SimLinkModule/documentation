...
Mittels einer seriellen Verbindung zwischen dem Entwicklercomputer und dem Mikrocontroller wird der ESP32-Mikcrontroller programmiert. Da jedoch heutzutage wenige Rechner eine serielle Busche besitzen, gibt es grundlegend zwei Möglichkeiten den ESP32 zu programmieren. Die erste Möglichkeit ist, ein USB-zu-Seriell-Programmiergerät zu verwenden, womit der Entwicklercomputer mittels USB die Programmierung durchführen kann. Die zweite Möglicheit ist, auf der eigententwickelten Platine ein USB-zu-Seriell-Converter \ac{IC} zu integrieren, womit direkt die Programmierung des ESP32 mittels USB erfolgen kann. Jedoch entstehen bei dieser Methode zusätzliche Kosten und es wird wichtiger Platz auf der Platine verschwendet, da das Erweiterungsmodul nur einmal nach der Bestückung der Platine programmiert werden muss. Aus diesen gennanten Einschränkungen wird die erste Möglichkeit zur Programmierung des ESP32 verwendet.
...
Da bei Tastern zu beginn einer Betätigung einige Sprünge zwischen Masse und der Betrieberspannung erfolgen bis das Signal eingeschwungen ist. In dieser Phasen würde ein Mikrocontroller falsche Auswertungen des Taster ausführuen, weshalb Taster immer im Betrieb mit Mikrocontrollern entprellt werden sollen. Eine einfache Methode ist die Entprellung mittels Hardwarekomponenten, wie in Abbildung \ref{fig:buttonDebounce} zu sehen ist. Das Hauptelement zur Entprellung ist dabei der parallel zum Taster platzierte Kondensator \cite{debounceButton}. Zusätzlich enhält jeder Kontakt des ESP32 einen internen Pull-Up Widerstand (45K Ohm), womit bei Nichtbetätigung des Tasters eine Spannung von 3,3~V am ESP32-Kontakt anliegt. Eine Betätigung des Tasters zieht folgend die Spannung des ESP32-Kontakts auf eine Spannung von 0~V.
...
Zur Vermeidung von Fehlern während des Schaltungsentwurfs und der Minimierung von Platininenproduktionsdurchgängen, bauen die Platienen des Erweiterungsmoduls auf Referenzdesings, welche in der nachfolgenden Liste zu sehen sind, auf.
