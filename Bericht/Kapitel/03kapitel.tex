...
Das \acl{HCI} stellt die Möglichkeit bereit, dass der Hostteil die Funktionen des Controllerteil erreichen kann. Die Übertragung des \ac{HCI} kann dabei wahlweise mittels \acs{USB}, \ac{UART} oder anderen Bussystemen stattfinden. \cite[S.~1735f.]{bluetoothCore}
