...
\section{Mikrocontroller ESP32}
%mehrere Kerne; Pins; Kommunikationsmöglichkeiten; CE Kennzeichnung
...
%schreiben wie normalerweise Text dargestellt wird und die alternative als Bitmap --> weniger ressourcen für die Textdarstellung
\todo[inline]{TODO: BITMAP Schriftarten}

\section{libevdev}
%schreiben was Libevdev unter linux macht --> muss nicht all zu viel sein
