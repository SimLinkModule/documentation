...
Schlussendlich können mittels Padding-Bits die enthaltenen Datenfelder byteorientiert ausgerichtet werden. In Tabelle \todo{Referenz hinzufügen} ist eine beispielhafte Datenstruktur für eine Maus mit dazugehörigen Report Deskriptor in Quellcode \todo{Referenz hinzufügen} zu sehen.

\todo[inline]{Tabelle erstellen}
\todo[inline]{Quellcode erstellen}
