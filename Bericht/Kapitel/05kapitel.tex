...
Ein wichtiges Merkmal von Fernsteuerung während der Verwendung im Simulator als auch mit einem reellen Multikopter stellt die Latenz zwischen der Eingabe an der Fernsteuerung bis zur Verarbeitung an der Gegenstelle dar. Um diese Latenz zu bestimmen wird in nachfolgenden Abschnitt der verwendete Versuchsaufbau beschrieben und darauffolgend die Ergebnisse ausgewertet und mit weiteren Computereingabegeräten verglichen.
...
Für den finalen Versuchsaufbau wird als Grundlage, das Versuchsverfahren von der Arbeit in Quelle \cite{wimmerLatenzStation} verwendet. Dieses Verfahren ist jedoch nicht mehr ohne Veränderungen an der Multikopterfernsteuerung möglich. Die Betätigung eines Tasters der Fernsteuerung findet hierbei mittels eines Optokopplers statt.
...
Zur Bestimmung der Latenz für Eingabesignale, welche mittels USB oder \ac{BLE} übertragen werden, wird als Auswertungseinheit ein Raspberry Pi Model B+ 
